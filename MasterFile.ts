...
function readCodeObject(bytecode:NodeBuffer,ptr:number,level:number) {
    ...
    var argcount = bytecode.readUInt32LE(ptr); ptr=ptr+4;
    console.log(prefix+'argcount:\n'+prefix+String(argcount));

    var nlocals = bytecode.readUInt32LE(ptr); ptr=ptr+4;
    console.log(prefix+'nlocals:\n'+prefix+String(nlocals));  

    var stacksize = bytecode.readUInt32LE(ptr); ptr=ptr+4;
    console.log(prefix+'stacksize:\n'+prefix+String(stacksize));

    var flags = bytecode.readUInt32LE(ptr); ptr=ptr+4;
